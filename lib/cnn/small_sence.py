...
class _sence_net(Net):
    ...
    def build_model(self):
        ...
        self.conv3_3 = self.conv('conv3_3', self.conv3_2, 32, stride=[1, 1, 1, 1])
        self.pool3 = self.pool('pool3', self.conv3_3, kernel=[1, 2, 2, 1], stride=[1, 2, 2, 1], is_max_pool=True)

        self.conv4_1 = self.conv('conv4_1', self.pool3, 64, stride=[1, 1, 1, 1])
        self.conv4_2 = self.conv('conv4_2', self.conv4_1, 64, stride=[1, 1, 1, 1])
        self.conv4_3 = self.conv('conv4_3', self.conv4_2, 64, stride=[1, 1, 1, 1])
        self.pool4 = self.pool('pool4', self.conv4_3, kernel=[1, 2, 2, 1], stride=[1, 2, 2, 1], is_max_pool=True)

        self.conv5_1 = self.conv('conv5_1', self.pool4, 32, stride=[1, 1, 1, 1])
        self.conv5_2 = self.conv('conv5_2', self.conv5_1, 32, stride=[1, 1, 1, 1])
        self.conv5_3 = self.conv('conv5_3', self.conv5_2, 32, stride=[1, 1, 1, 1])
        self.pool5 = self.pool('pool5', self.conv5_3, kernel=[1, 2, 2, 1], stride=[1, 2, 2, 1], is_max_pool=True)

        self.fc6 = self.fc('fc6', self.pool5, out_nodes=256)
